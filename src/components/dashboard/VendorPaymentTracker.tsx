    ...
    >
      ...
      <div
        ...
        style={{
          ...
          marginBottom: 14,
          paddingBottom: 12,
          borderBottom: '1px solid var(--landing-border, var(--nikah-border))',
        }}
      >
        {[
          ...
          <div key={item.label}>
            <div className="font-extrabold text-nikah-deep" style={{ fontSize: 14.5, lineHeight: 1.1 }}>{item.value}</div>
            <div className="text-nikah-muted uppercase font-bold" style={{ fontSize: 9.5, letterSpacing: '0.1em', marginTop: 4 }}>{item.label}</div>
          </div>
        ))}
      </div>
            ...
            >
              <span
                ...
                style={{
                  ...
                  width: 3,
                  borderRadius: 999,
                  background: itemRemaining > 0 ? 'var(--landing-rose-text, #C16E73)' : 'var(--landing-mauve, #B98789)',
                  opacity: 0.72,
                }}
              />
              ...
              <div style={{ background: 'rgba(255,255,255,0.68)', height: 5, borderRadius: 999, marginTop: 10, overflow: 'hidden' }}>
                <div
                  style={{
                    ...
                    height: '100%',
                    borderRadius: 999,
                    background: 'linear-gradient(90deg, var(--landing-mauve, var(--nikah-mauve)), var(--nikah-gold))',
                  }}
                />
              </div>
      ...
      {formOpen && (
        <div className="grid bg-nikah-bg" style={{ gap: 8, marginTop: 10, padding: 12, borderRadius: 16 }}>
          <input
            value={draft.name}
